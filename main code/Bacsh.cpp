...
Equal_Case_String(char *Command,char *Key_String)
{
	int Counter_02=0;
...
Chroot(char *Path_Flag_02,char *Path_Flag_03,char *Command,char *Function_String,int Path_Flag_01,char *Isolate_Path_02)
{
...
Reset(int Char_Key_Flag_04,int Counter_04)
{
...
Cat_Detect(char *Function_String,char *Command,char *Path_Flag_02)
{
...
main(int argc, char *argv[])
{
	...
	char Ac_Command[21],Ac_Character;
    char Key_Word_01;
	char Buffer_X[1024];
    char Buffer_Y[1024];
	char Path_Flag_02[100];
	char Path_Flag_03[100];
	...
	char Home_Path[53]="C:\\Users\\kali\\Shell\\";
