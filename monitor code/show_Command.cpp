...
main()
{
	...
	SetWindowPos(hwnd, HWND_TOP, 0, 0, cx/2, cy/2, 0);
	system("cls"); 
	...
	while((access("C:\\Users\\Public\\tmp22.txt",F_OK))!=-1)
	{
		while(Tmp_Flag_01[0]=='1')
		{
			...
			printf("\t\033[1m[\033[1;32m+\033[0m\033[1m]\033[0m \033[1;34mø™ ºº‡≤‚”√ªß ‰»Î£∫\033[0m\n");
			printf("Every 1.0s: cat C:\\Users\\Public\\History\\Command.txt -Tail 10\n");
			printf("    %s:%s\n\n",Computer_Name,Time_Handel);
			system("powershell -c \"cat C:\\Users\\Public\\History\\Command.txt -Tail 10 2>$null\"");
			Sleep(1000);
		}
		system("cls");
		printf("  Waiting....");
